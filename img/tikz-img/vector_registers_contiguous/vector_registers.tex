...
\fill[red!30] (memrow-1-1.north west) rectangle (memrow-1-4.south east);
\fill[blue!30] (memrow-1-5.north west) rectangle (memrow-1-8.south east);
\fill[green!30] (memrow-1-9.north west) rectangle (memrow-1-12.south east);
\fill[yellow!30] (memrow-1-13.north west) rectangle (memrow-1-16.south east);
%
...
\draw[->] (memrow-1-2.south east) to[out=-90, in=90] (memory-2-3.north east) ;
%\draw[->] (memrow-1-3.center) to[out=-90, in=90] (memory-2-4.center) ;
%\draw[->] (memrow-1-4.center) to[out=-90, in=90] (memory-2-5.center) ;
