...
\newacronym{bridge}{BRIDGE}{Bristol Research Initiative for the Dynamic Global Environment}
...
%This implies that the runtime decreases as the number of processor cores increases, however this is not always the case and is dependant on the problem domain.
...
%These optimisations have been evaluated to ensure they provide a significant performance improvement, whilst retaining the scientific validity of Isca.
...
\par
%If the Arm architecture is to be widely adopted for the purpose of \gls{hpc}, more scientific codes need to be ported and benchmarked on the hardware. Popular libraries such as \gls{fftw} have been optimised for Arm be 
...
\section*{BCP3 Intel}
\begin{lstlisting}[language=Bash,caption={Environment file for BCP3 using ICC.}]
...
\section*{BCP3 (PBS)}
\begin{lstlisting}[language=Bash, caption={Job submission script for BCP3.}]
#!/bin/sh
